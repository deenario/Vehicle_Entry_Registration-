...
{
    public partial class Alone_Person_search : Form
    {
        SqlConnection con;
        public Alone_Person_search()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("Search_Person_CNIC", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add("person_CNIC", SqlDbType.VarChar).Value = txt_PCNIC.Text;
        ...
        {
            report_individual_search frm = new report_individual_search(txt_PCNIC.Text);
            frm.Show();
        }

        private void Alone_Person_search_Load(object sender, EventArgs e)
        {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                ds.Tables.Add(dt);
                ExportDataSetToExcel(ds, saveFileDialog1.FileName);
            } 
        }
