...
{
    public partial class Trip_Shee__Of_Companion : Form
    {
        SqlConnection con;
        public Trip_Shee__Of_Companion()
        {
            InitializeComponent();
            con = new SqlConnection(SqlHelper.Global_Connection_String);
        }

        private void Trip_Shee__Of_Companion_Load(object sender, EventArgs e)
        {
        ...
        {
            SqlCommand cmd = new SqlCommand("Search_companions",con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add("A_CNIC", SqlDbType.VarChar).Value = txt_PCNIC.Text;
            cmd.Parameters.Add("B_CNIC", SqlDbType.VarChar).Value = textBox3.Text;
        ...
        {
            Report_companion_trip_sheet frm = new Report_companion_trip_sheet(txt_PCNIC.Text, textBox3.Text);
            frm.Show();
        }
